...
# ============================================================================
# NOTE: This file contains ONLY the Streamlit UI — theming, layout, animations,
# mood selector, and chat display. It does NOT contain any LLM / LangChain
# logic. Plug your model-calling code into `get_bot_response()` near the
# bottom (that's where the core logic file's `model.invoke(...)` call goes).
# ============================================================================

# ----------------------------------------------------------------------------
# MOOD DEFINITIONS (UI metadata: colors, emojis, avatar, label per mood)
# ----------------------------------------------------------------------------
MOODS = {
    "Cheerful 😃": {
        "primary": "#FFD93D",
...
if mood_choice != st.session_state.selected_mood_key:
    ...
    st.session_state.display_history = []  # reset chat display on mood switch
...
# ----------------------------------------------------------------------------
# HEADER (sticky - stays put while chat messages scroll)
# ----------------------------------------------------------------------------
st.markdown(
    f"""
...
# Replace this function's body with your actual model call
# (build the LangChain message list, call model.invoke(...), return the text).
# ----------------------------------------------------------------------------
def get_bot_response(user_input: str) -> str:
    return "🔌 Connect your LLM logic here to get a real reply."
